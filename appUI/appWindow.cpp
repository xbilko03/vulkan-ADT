...
namespace details {
    ...
    bool appWindow::LoadImageTexture(unsigned long long ID, int width, int height, int channels, void* imageData)
    {
        ...
        // Create the Vulkan image.
        {
            ...
            info.extent.width = my_texture.Width;
            info.extent.height = my_texture.Height;
            info.extent.depth = 1;
            info.mipLevels = 1;
            info.arrayLayers = 1;
        ...
        my_texture.DS = ImGui_ImplVulkan_AddTexture(my_texture.Sampler, my_texture.ImageView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
        ...
        // Copy to Image
        {
            ...
            copy_barrier[0].image = my_texture.Image;
            ...
            region.imageExtent.width = my_texture.Width;
            region.imageExtent.height = my_texture.Height;
            region.imageExtent.depth = 1;
            vkCmdCopyBufferToImage(command_buffer, my_texture.UploadBuffer, my_texture.Image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &region);
            ...
            use_barrier[0].image = my_texture.Image;
